...
#creating a vector 1-9
int_vect <- 1:9

#setting vector char_vect to a vector A-Q
char_vect <- LETTERS[1:17]


#checking to see if this will return the vector of everything after D
intermediate_vect <- char_vect[char_vect >"D"]

#returns length of new vector after D
lengt_of_char <- length(char_vect[char_vect > "D"])
